...
{	
	...
	if (mSystemMgr->KeyPressed(PSP_CTRL_UP) || mSystemMgr->KeyPressed(PSP_CTRL_DOWN) || mSystemMgr->KeyPressed(PSP_CTRL_RIGHT) || mSystemMgr->KeyPressed(PSP_CTRL_LEFT))
	{
...
void StateMenu::Draw(StateManager* sManager)
{
	...
	case 12: //Multiplayer
	{
		...
		//back
		sbuttonSprite->SetPosition(240,225);
		sbuttonSprite->Draw();
		DrawText(240, 233, GU_COLOR(1, 1, 0.25, 1), default_size, "Back");

		
		DrawText(240, 140, GU_COLOR(1, 1, 1, 1), default_big_size, "Iridescence Do Something");	
	}
	break;
	...
	case -1://main menu
    {
        ...
        {
            selectPos == 0 ? DrawText(240,99,GU_COLOR(1,1,0.25,1) ,default_size,"Singleplayer") : DrawText(240,99,GU_COLOR(1,1,1,1) ,default_size,"Singleplayer");
			selectPos == 1 ? DrawText(240, 129, GU_COLOR(1, 1, 0.25, 1), default_size, "Multiplayer") : DrawText(240, 129, GU_COLOR(1, 1, 1, 1), default_size, "Multiplayer");
            selectPos == 2 ? DrawText(240,159,GU_COLOR(1,1,0.25,1) ,default_size,"Help & Options") : DrawText(240,159,GU_COLOR(1,1,1,1) ,default_size,"Help & Options");
			selectPos == 3 ? DrawText(240,189,GU_COLOR(1,1,0.25,1) ,default_size,"News & Converter") : DrawText(240,189,GU_COLOR(1,1,1,1) ,default_size,"News & Converter");
            selectPos == 4 ? DrawText(240,219,GU_COLOR(1,1,0.25,1) ,default_size,"Texture Packs") : DrawText(240,219,GU_COLOR(1,1,1,1) ,default_size,"Texture Packs");
			selectPos == 5 ? DrawText(50,260,GU_COLOR(1,1,0.25,1) ,default_small_size,"Minecraft v3.0.1") : DrawText(50,260,GU_COLOR(1,1,1,1) ,default_small_size,"Minecraft v3.0.1");
			selectPos == 6 ? DrawText(350,260,GU_COLOR(1,1,0.25,1) ,default_small_size,"Copyright Mojang AB. Do not distribute!") : DrawText(350,260,GU_COLOR(1,1,1,1) ,default_small_size,"Copyright Mojang AB. Do not distribute!");
    ...
    case 1://select world
    {
        ...
        if(mRender->GetFontLanguage() == ENGLISH)
        {
			...
			DrawText(240, 24, GU_COLOR(1, 1, 1, 1), default_size, "L Trigger                                       R Trigger");
    ...
    case 3://about
    {
        ...
        if(mRender->GetFontLanguage() == ENGLISH)
        {
            ...
            DrawText(240,29,GU_COLOR(1,1,1,1) ,default_size,"UPDATE NEWS 3.0.1");
        }
    }
    break;
